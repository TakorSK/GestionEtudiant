...
====================================== SOUFIANE =======================================
TODO
    - Test The Database (should be done soon, currently having problems with the database staying closed when launching the app, which makes it impossible to interact with)
